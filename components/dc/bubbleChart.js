...
const bubbleChartFunc = (divRef, ndx) => {
	...
	const yearlyPerformanceGroup = yearlyDimension
		.group()
		.reduce(groupAddReducer, groupRemoveReducer, groupInitalizer);
	const yearlyBubbleChart = dc.bubbleChart(divRef); // Divref is a reference to the div we're attaching to
	yearlyBubbleChart
